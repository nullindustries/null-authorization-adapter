...
(function() {
  ...
  exports.register = function(options) {
    ...
    excludeFile = function(fileName) {
      var component, components, exclude, excludePath, excluded, relativeFilename, _i, _j, _k, _len, _len1, _len2, _ref1;
      exclude = options.exclude || [];
      excluded = false;
      if (basePath) {
      ...
      if (!excluded && (_ref1 = !path.extname(fileName), __indexOf.call(Object.keys(EXTENSIONS), _ref1) >= 0)) {
        excluded = true;
      }
      if (!excluded) {
